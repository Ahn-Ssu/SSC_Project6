...
public class AI {
	...
	public void setting() {
		...
		//바보수 case 1 : (검은색으로) 양쪽이 막힌 곳, 4개
				
		foolData.put("22, 0, 0, 11, 11, 11, 22", 2);
		foolData.put("22, 0, 11, 0, 11, 11, 22", 3);
		foolData.put("22, 0, 11, 11, 0, 11, 22", 4);
		foolData.put("22, 0, 11, 11, 11, 0, 22", 5);
		foolData.put("22, 11, 0, 11, 11, 0, 22", 2);
		foolData.put("22, 11, 11, 0, 11, 0, 22", 3);
		foolData.put("22, 11, 11, 11, 0, 0, 22", 4);		
		foolData.put("22, 0, 11, 11, 11, 22", 1);
		foolData.put("22, 11, 0, 11, 11, 22", 2);
		foolData.put("22, 11, 11, 0, 11, 22", 3);
		foolData.put("22, 11, 11, 11, 0, 22", 4);	
		//바보수 case 2 : (검은색으로) 양쪽이 막힌 곳, 3개 
		...
		//바보수 case 3 : (적색, 검은색으로) 양쪽이 막힌 곳, 4개
		
		foolData.put("99, 0, 0, 11, 11, 11, 22", 2);
		foolData.put("99, 0, 11, 0, 11, 11, 22", 3);
		foolData.put("99, 0, 11, 11, 0, 11, 22", 4);
		foolData.put("99, 0, 11, 11, 11, 0, 22", 5);	
		foolData.put("99, 11, 0, 11, 11, 0, 22", 2);
		foolData.put("99, 11, 11, 0, 11, 0, 22", 3);
		foolData.put("99, 11, 11, 11, 0, 0, 22", 4);		
		foolData.put("99, 0, 11, 11, 11, 22", 1);
		foolData.put("99, 11, 0, 11, 11, 22", 2);
		foolData.put("99, 11, 11, 0, 11, 22", 3);
		foolData.put("99, 11, 11, 11, 0, 22", 4);
		//바보수 case 4 : (적색, 검은색으로) 양쪽이 막힌 곳, 3개
		...
		//바보수 case 5 : (검은색, 적색으로) 양쪽이 막힌 곳, 4개
		
		foolData.put("22, 0, 0, 11, 11, 11, 99", 2);
		foolData.put("22, 0, 11, 0, 11, 11, 99", 3);
		foolData.put("22, 0, 11, 11, 0, 11, 99", 4);
		foolData.put("22, 0, 11, 11, 11, 0, 99", 5);	
		foolData.put("22, 11, 0, 11, 11, 0, 99", 2);
		foolData.put("22, 11, 11, 0, 11, 0, 99", 3);
		foolData.put("22, 11, 11, 11, 0, 0, 99", 4);	
		foolData.put("22, 0, 11, 11, 11, 99", 1);
		foolData.put("22, 11, 0, 11, 11, 99", 2);
		foolData.put("22, 11, 11, 0, 11, 99", 3);
		foolData.put("22, 11, 11, 11, 0, 99", 4);
		//바보수 case 6 : (검은색, 적색으로) 양쪽이 막힌 곳, 3개
		...
		foolData.put("99, 0, 0, 11, 11, 11, 99", 2);
		foolData.put("99, 0, 11, 0, 11, 11, 99", 3);
		foolData.put("99, 0, 11, 11, 0, 11, 99", 4);
		foolData.put("99, 0, 11, 11, 11, 0, 99", 5);	
		foolData.put("99, 11, 0, 11, 11, 0, 99", 2);
		foolData.put("99, 11, 11, 0, 11, 0, 99", 3);
		foolData.put("99, 11, 11, 11, 0, 0, 99", 4);			
		foolData.put("99, 0, 11, 11, 11, 99", 1);
		foolData.put("99, 11, 0, 11, 11, 99", 2);
		foolData.put("99, 11, 11, 0, 11, 99", 3);
		foolData.put("99, 11, 11, 11, 0, 99", 4);
